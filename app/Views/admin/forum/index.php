...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="<?= base_url('admin/forum/create') ?>" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded font-semibold transition-colors">
            + Create New Thread
        </a>
    </div>
